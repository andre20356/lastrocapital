                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5 text-center">
                          {(() => {
                            if (isOverdue) {
                              const overdueCount = calcOverdueInstallments(inv.dueDate, inv.recurrence);
                              return overdueCount > 0 ? (
                                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-destructive/10 border border-destructive/25 text-xs font-bold text-destructive whitespace-nowrap">
